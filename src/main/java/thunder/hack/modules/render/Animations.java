...
public class Animations extends Module {
    ...
    public void renderItem(LivingEntity entity, ItemStack stack, ModelTransformationMode renderMode, boolean leftHanded, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
        if (stack.isEmpty()) {
            return;
        } //    TODO: these are quite questionable                                                       \/ mc.world?? changed from ent.method_48926   \/ also why is this the seed lol
        mc.getItemRenderer().renderItem(entity, stack, renderMode, leftHanded, matrices, vertexConsumers, mc.world, light, OverlayTexture.DEFAULT_UV, entity.getId() + renderMode.ordinal());
    }
